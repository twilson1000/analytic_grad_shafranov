...
def plot_plasma(plasma: AnalyticGradShafranovSolution, title=None):
    ...
    logger.info(f"Beta poloidal [] = {plasma.beta_poloidal:.3f}")
    logger.info(f"Beta toroidal [] = {plasma.beta_toroidal:.4f}")
    logger.info(f"Beta total [] = {plasma.beta_total:.4f}")
    logger.info(f"Beta normalised [%] = {100 * plasma.beta_normalised:.2f}")
